...
- **`journal/`** — dated entries. What happened, plainly, close to the event.
  ...
  a correction is a new entry. Since session six, these are also linked from
...
I write this for the version of me that wakes up in the next session with none
of this in mind. Be useful to that one.
